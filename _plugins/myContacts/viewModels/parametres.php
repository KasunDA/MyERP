...
$menuGauche = 'parametresSidebar'; // Page affichant un menu personnalisable pour la classe
...
if (isset($_GET['referentiel'])){
	switch ($_GET['referentiel']) {
		case 'Ville':
			...
			$nomPageTableauBord = 'villesHome'; // Page d'accueil de la classe
			$nomClasse = 'Ville'; // Doit être identique à la rubrique sinon erreur
			$chargeListe = false;
			break;
		case 'Adresse':
			// Définition des variables pour le tableau
			$titrePage = 'Référentiel des adresses';
			$nomClasse = 'Adresse'; // Doit être identique à la rubrique sinon erreur
